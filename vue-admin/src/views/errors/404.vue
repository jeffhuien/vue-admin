...
<template>
  ...
  <div class="relative w-full h-full flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
    <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
      ...
      <p class="text-lg md:text-xl lg:text-2xl text-gray-500 my-12">该页面丢失了哦~</p>
    ...
    <div class="w-1/2 lg:h-full flex lg:items-end justify-center p-4 sm:-translate-y-40">
      <svg class="w-full text-blue-600" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 1120.59226 777.91584" xmlns:xlink="http://www.w3.org/1999/xlink">
